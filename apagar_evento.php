...
if (!empty($id)) {
    ...
    $query_apagar_event = "DELETE FROM tb_calendario WHERE cal_id=?";

    // Preparar a QUERY
    $apagar_event = $con->prepare($query_apagar_event);

    // Substituir o link pelo valor
    $apagar_event->bind_param("i", $id); // "i" indica que o parâmetro é um inteiro
