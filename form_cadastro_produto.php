                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Formulário de Produtos</h4>
                            </div> 
                                ...
                                <div class="basic-form">
                                    ...
                                    <form name="frm_produto" method="post" action="cadastro/cadastro_produto.php" id="frm_produto">
                                        ...
                                        <div class="col-lg-12 mb-4">
                                            ...
                                            <textarea class="form-control" rows="4" name="txt_descricao" id="txt_descricao" placeholder="Faça uma Breve Descrição do Produto"></textarea>
                                        </div>
