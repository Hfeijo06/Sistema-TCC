                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <?php while ($dados = mysqli_fetch_array($sql)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dados['cli_endereco']; ?></td>
                                                ...
                                                <td>
                                                    <span>
                                                        ...
                                                        <a href="deletar/delete_cliente.php?cli_codigo=<?php echo $dados['cli_codigo']; ?>" data-toggle="tooltip" data-placement="top" title="Close">
