                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Consulta de Estoque</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        ...
                                                        <a href="deletar/delete_estoque.php?est_codigo=<?php echo $dados['est_codigo']; ?>" data-toggle="tooltip" data-placement="top" title="Close">
