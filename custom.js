...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            document.getElementById("visualizar_descricao").innerText = info.event.extendedProps.descricao || 'Descrição não disponível';    
        ...
        btnApagarEvento.addEventListener("click", async () => {
            ...
            if (confirmacao) {
                ...
                if (!resposta['status']) {
                    ...
                    // Fechar o modal
                    const visualizarModal = bootstrap.Modal.getInstance(document.getElementById("visualizarModal"));
