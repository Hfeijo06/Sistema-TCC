...
$sql = "SELECT *, DATE_FORMAT(c.com_data, '%d/%m/%Y') AS data, f.for_nome 
        FROM tb_compra AS c
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Formulário de Contas à Pagar</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Formulário de Contas à Pagar</h4>
                            </div> 
                            ...
                            <div class="card-body">
                                ...
                                <form name="frm_pagar" method="post" action="cadastro/cadastro_conta_pagar.php" id="frm_pagar">
                                    <div class="col-lg-12 mb-4">
                                        <input type="text" hidden class="form-control" name="txt_compra" id="txt_compra" value="<?php echo $dados['com_codigo']; ?>">
                                    </div>
                                            ...
                                            <div class="d-flex">
                                                <select class="form-control flex-grow-1" name="txt_despesa" id="txt_despesa" required>
                                                    ...
                                                    <?php while ($dados2 = mysqli_fetch_array($sql2)) { ?>
                                                        <option value="<?php echo $dados2['des_codigo']; ?>"><?php echo $dados2['des_nome']; ?></option>
                                                    <?php } ?>
                                                </select>
                                    ...
                                    <div class="col-lg-12 mb-4">
                                        <label>Valor</label>
                                        <input type="number" class="form-control" name="txt_valor" id="txt_valor" placeholder="Digite o Valor da Conta a Receber">
                                    </div>

                                    <div class="col-lg-12 mb-4">
                                        <label>Vencimento</label>
                                        <input type="date" class="form-control" name="txt_vencimento" id="txt_vencimento">
                                    </div>
                                    ...
                                    <script>
                                        document.getElementById("btn_cancelar").addEventListener("click", function() {
                                            ...
                                            document.forms["frm_pagar"].reset();
                                        });
                                    </script>
                                </form>
                                <script>
                                    document.getElementById("btn_salvar1").addEventListener("click", function(event) {
                                        ...
                                        var despesa = document.getElementById("txt_despesa");
                                        var valor = document.getElementById("txt_valor");
                                        var vencimento = document.getElementById("txt_vencimento");
                                        ...
                                        if (despesa.value === "" || despesa.value === "Escolha Uma Opção") {
                                            marcarErro(despesa);
                                        } else {
                                            despesa.style.border = ''; // Remove borda vermelha se estiver correto
                                        }
                                        ...
                                        if (vencimento.value === "") {
                                            ...
                                            vencimento.style.border = ''; // Remove borda vermelha se estiver correto
                                        }
                                        ...
                                        if (valid) {
                                            document.getElementById("frm_pagar").submit();
                                        }
                                    });
                                </script>
                                                                            ...
                                                                            function confirmDelete(des_codigo) {
                                                                                Swal.fire({
                                                                                    ...
                                                                                    if (result.isConfirmed) {
                                                                                        window.location.href = 'deletar/delete_despesa2.php?des_codigo=' + des_codigo;
                                                                                    }
                                                                                });
                                                                            }
                                                                        </script>
